      ...
      <div className="bg-[#FFFFFF] rounded-[26px]  p-6  ">
        ...
        <div>
          ...
          <div className="text-[16px] text-[#00000080]   ">
            <p className="">
              By accessing and placing an order with Career Prep Toolbox, you
              ...
              communication between you and Career Prep Toolbox.
            </p>
            <p className="">
              Under no circumstances shall Career Prep Toolbox team be liable
              ...
              this site, even if Career Prep Toolbox team or an authorized
            ...
            <p>
              Career Prep Toolbox will not be responsible for any outcome that
              may occur during the course of usage of our resources. We reserve
              the rights to change prices and revise the resources usage policy
              in any moment.{" "}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="text-[16px] text-[#00000080]  ">
          <p  className="">
            Career Prep Toolbox grants you a revocable, non-exclusive,
          ...
          <p className="">
            These Terms & Conditions are a contract between you and Career Prep
            Toolbox (referred to in these Terms & Conditions as "Career Prep
            Toolbox", "us", "we" or "our"), the provider of the Career Prep
            Toolbox website and the services accessible from the Career Prep
            Toolbox website (which are collectively referred to in these Terms &
            Conditions as the "Career Prep Toolbox Service").
          </p>
          <p className="">
            You are agreeing to be bound by these Terms & Conditions. If you do
            not agree to these Terms & Conditions, please do not use the Career
            Prep Toolbox Service. In these Terms & Conditions, "you" refers both
        ...
        <div>
          ...
          <ul className=" leading-[30px] text-justify ">
            <li>
            <span className="text-black font-[500]">• Cookie:</span>   small amount of data generated by a website and saved by
            ...
            <li>
            <span className="text-black font-[500]">  • Company:</span> when this terms mention â€œCompany,â€ â€œwe,â€ â€œus,â€
              or â€œour,â€ it refers to Second Shot Technologies, (3225 McLeod
              DR Suite 100 Las Vegas Nv 89121 United States), that is
              responsible for your information under this Terms & Conditions.
            </li>
            <li>
            <span className="text-black font-[500]">   • Country:</span> where Career Prep Toolbox or the owners/founders of
              Career Prep Toolbox are based, in this case is United States
            </li>
            <li>
            <span className="text-black font-[500]"> • Device:</span> any internet connected device such as a phone, tablet,
              computer or any other device that can be used to visit Career Prep
              Toolbox and use the services.
            </li>
            <li>
            <span className="text-black font-[500]">• Service:</span> refers to the service provided by Career Prep Toolbox
              as described in the relative terms (if available) and on this
              platform.
            </li>
            <li>
            <span className="text-black font-[500]">• Third-party service:</span> refers to advertisers, contest sponsors,
            ...
            <li>
            <span className="text-black font-[500]"> • You:</span> a person or entity that is registered with Career Prep
              Toolbox to use the Services.
            </li>
          </ul>
          </div>
        </div>
        <div>
          ...
          <ul>
            <li>
            <span className="text-black font-[500]"> • License</span>  , sell, rent, lease, assign, distribute, transmit, host,
              outsource, disclose or otherwise commercially exploit the
              website/app or make the platform available to any third party.
            </li>
            <li>
            <span className="text-black font-[500]">• Modify</span>  , make derivative works of, disassemble, decrypt, reverse
              compile or reverse engineer any part of the website/app.
            </li>
            <li>
            <span className="text-black font-[500]"> • Remove</span>, alter or obscure any proprietary notice (including any
              notice of copyright or trademark) of Career Prep Toolbox or its
        ...
        <div>
          ...
          <p>
            Thanks for shopping at Career Prep Toolbox. We appreciate the fact
            that you like to buy the stuff we build. We also want to make sure
            you have a rewarding experience while youâ€™re exploring,
            evaluating, and purchasing our products.
          </p>
          <p>
            As with any shopping experience, there are terms and conditions that
            apply to transactions at Career Prep Toolbox. Weâ€™ll be as brief as
            our attorneys will allow. The main thing to remember is that by
            placing an order or making a purchase at Career Prep Toolbox, you
            agree to the terms along with Career Prep Toolboxâ€™s Privacy
            Policy.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            (collectively, "Suggestions") provided by you to Career Prep Toolbox
            with respect to the website/app shall remain the sole and exclusive
            property of Career Prep Toolbox.
          </p>
          <p>
            Career Prep Toolbox shall be free to use, copy, modify, publish, or
        ...
        <div>
          ...
          <p>
            ...
            Career Prep Toolbox. We are not responsible for the content,
            ...
            subject to that websiteâ€™s own rules and policies. Such third
        ...
        <div>
          ...
          <p>
            ...
            website/app that you have visited. A Cookie is a small piece of data
            ...
            you may not be able to access functionality on our website/app
        ...
        <div>
          ...
          <p>
            You acknowledge and agree that Career Prep Toolbox may stop
            (permanently or temporarily) providing the Service (or any features
            within the Service) to you or to users generally at Career Prep
            Toolboxâ€™s sole discretion, without prior notice to you. You may
            stop using the Service at any time. You do not need to specifically
            inform Career Prep Toolbox when you stop using the Service. You
            acknowledge and agree that if Career Prep Toolbox disables access to
        ...
        <div>
          ...
          <p>
            Career Prep Toolbox reserves the right to modify, suspend or
        ...
        <div>
          ...
          <p>
            Career Prep Toolbox may from time to time provide enhancements or
          ...
          <p>
            ...
            of the website/app. You agree that Career Prep Toolbox has no
        ...
        <div>
          ...
          <p>
            ...
            decency, quality or any other aspect thereof. Career Prep Toolbox
        ...
        <div>
          ...
          <p>
            Career Prep Toolbox may, in its sole discretion, at any time and for
          ...
          <p>
            ...
            Career Prep Toolbox, in the event that you fail to comply with any
          ...
          <p>
            Termination of this Agreement will not limit any of Career Prep
            Toolbox's rights or remedies at law or in equity in case of breach
        ...
        <div>
          ...
          <div>
            ...
            <p>
              You agree to indemnify and hold Career Prep Toolbox and its
          ...
          <div>
            ...
            <p>
              ...
              maximum extent permitted under applicable law, Career Prep
              Toolbox, on its own behalf and on behalf of its affiliates and its
              ...
              Without limitation to the foregoing, Career Prep Toolbox provides
              no warranty or undertaking, and makes no representation of any
              kind that the website/app will meet your requirements, achieve any
            ...
            <p>
              Without limiting the foregoing, neither Career Prep Toolbox nor
              any Career Prep Toolbox's provider makes any representation or
              warranty of any kind, express or implied: (i) as to the operation
              or availability of the website/app, or the information, content,
              and materials or products included thereon; (ii) that the
              website/app will be uninterrupted or error-free; (iii) as to the
              accuracy, reliability, or currency of any information or content
              provided through the website/app; or (iv) that the website/app,
              its servers, the content, or e-mails sent from or on behalf of
              Career Prep Toolbox are free of viruses, scripts, trojan horses,
          ...
          <div>
            ...
            <p>
              ...
              liability of Career Prep Toolbox and any of its suppliers under
              any provision of this Agreement and your exclusive remedy for all
              of the foregoing shall be limited to the amount actually paid by
              you for the website/app.
            </p>
            <p>
              To the maximum extent permitted by applicable law, in no event
              shall Career Prep Toolbox or its suppliers be liable for any
              ...
              Agreement), even if Career Prep Toolbox or any supplier has been
          ...
          <div>
            ...
            <p>
              ...
              legal notices published by Career Prep Toolbox on the Services,
              shall constitute the entire agreement between you and Career Prep
              Toolbox concerning the Services. If any provision of this
              ...
              other term, and Career Prep Toolboxâ€™s failure to assert any
              right or provision under this Agreement shall not constitute a
              waiver of such right or provision. YOU AND Career Prep Toolbox
          ...
          <div>
            ...
            <p>
              Career Prep Toolbox reserves the right, at its sole discretion, to
          ...
          <div>
            ...
            <p>
              ...
              Career Prep Toolbox regarding your use of the website/app and
              supersedes all prior and contemporaneous written or oral
              agreements between you and Career Prep Toolbox.
            </p>
            <p>
              You may be subject to additional terms and conditions that apply
              when you use or purchase other Career Prep Toolbox's services,
              which Career Prep Toolbox will provide to you at the time of such
              use or purchase.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p>
              ...
              selection and arrangement thereof), are owned by Career Prep
              Toolbox, its licensors or other providers of such material and are
              ...
              part, without the express prior written permission of Career Prep
              Toolbox, unless and except as is expressly provided in these Terms
          ...
          <div>
            ...
            <p>
              ...
              REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR Career Prep
              Toolboxâ€™s INTELLECTUAL PROPERTY RIGHTS. The term â€œdisputeâ€
              means any dispute, action, or other controversy between you and
              Career Prep Toolbox concerning the Services or this agreement,
              whether in contract, warranty, tort, statute, regulation,
              ordinance, or any other legal or equitable basis. â€œDisputeâ€
          ...
          <div>
            ...
            <p>
              In the event of a dispute, you or Career Prep Toolbox must give
              the other a Notice of Dispute, which is a written statement that
              sets forth the name, address, and contact information of the party
              giving it, the facts giving rise to the dispute, and the relief
              requested. You must send any Notice of Dispute via email to:
              Info@yoursecondshot.com. Career Prep Toolbox will send any Notice
              of Dispute to you by mail to your address if we have it, or
              otherwise to your email address. You and Career Prep Toolbox will
              ...
              sixty (60) days, you or Career Prep Toolbox may commence
              arbitration.
            </p>
          </div>
          <div>
            ...
            <p>
              If you and Career Prep Toolbox donâ€™t resolve any dispute by
              informal negotiation, any other effort to resolve the dispute will
              be conducted exclusively by binding arbitration as described in
              ...
              the American Arbitration Association. Either party may seek any
              interim or preliminary injunctive relief from any court of
              competent jurisdiction, as necessary to protect the partyâ€™s
          ...
          <div>
            ...
            <p>
              ...
              property of Career Prep Toolbox without any compensation or credit
              to you whatsoever. Career Prep Toolbox and its affiliates shall
              have no obligations with respect to such submissions or posts and
          ...
          <div>
            <h2>Promotions</h2>
            <p>
              Career Prep Toolbox may, from time to time, include contests,
              promotions, sweepstakes, or other activities (â€œPromotionsâ€)
          ...
          <div>
            ...
            <p>
              ...
              signed by an authorized representative of Career Prep Toolbox.
              Career Prep Toolbox will be entitled to injunctive or other
              ...
              Career Prep Toolbox operates and controls the Career Prep Toolbox
              Service from its offices in United States. The Service is not
              ...
              choose to access the Career Prep Toolbox Service from other
              ...
              incorporate the Career Prep Toolbox Privacy Policy) contains the
              entire understanding, and supersedes all prior understandings,
              between you and Career Prep Toolbox concerning its subject matter,
              and cannot be changed or modified by you. The section headings
              used in this Agreement are for convenience only and will not be
          ...
          <div>
            <h2>Disclaimer</h2>
            <p>
              Career Prep Toolbox is not responsible for any content, code or
              any other imprecision.
            </p>
            <p>
              Career Prep Toolbox does not provide warranties or guarantees.
            </p>
            <p>
              In no event shall Career Prep Toolbox be liable for any special,
            ...
            <p>
              The Career Prep Toolbox Service and its contents are provided "as
              is" and "as available" without any warranty or representations of
              any kind, whether express or implied. Career Prep Toolbox is a
              distributor and not a publisher of the content supplied by third
              parties; as such, Career Prep Toolbox exercises no editorial
              control over such content and makes no warranty or representation
              ...
              the Career Prep Toolbox Service. Without limiting the foregoing,
              Career Prep Toolbox specifically disclaims all warranties and
              representations in any content transmitted on or in connection
              with the Career Prep Toolbox Service or on sites that may appear
              as links on the Career Prep Toolbox Service, or in the products
              provided as a part of, or otherwise in connection with, the Career
              Prep Toolbox Service, including without limitation any warranties
              of merchantability, fitness for a particular purpose or
              non-infringement of third party rights. No oral advice or written
              information given by Career Prep Toolbox or any of its affiliates,
              ...
              without notice. Without limiting the foregoing, Career Prep
              Toolbox does not warrant that the Career Prep Toolbox Service will
