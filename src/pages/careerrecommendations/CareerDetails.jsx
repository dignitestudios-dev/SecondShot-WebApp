...
function CareerDetails() {
  ...
  console.log(careerFiltered, "careerFiltered");
  return (
    <div className="">
    <div className="mb-3">
          ...
          <div className="grid grid-cols-3 divide-x-[1px] gap-4 text-[#011225]">
            <ul className="pl-8 space-y-6 list-disc list-inside">
              ...
              {loader ? (
                ...
                careerFiltered[0]?.career?.sample_job_titles?.map((item, index) => (
                  <li className="font-[500] list-outside text-[18px]" key={index}>
                    {item}
                  </li>
                ))
              ) : (
            ...
            <ul className="pl-8 space-y-6 list-disc list-inside">
              ...
              {loader ? (
                ...
                careerFiltered[0]?.career?.career_pathways.map((item, index) => (
                  <li className="font-[500] list-outside text-[18px]" key={index}>
                    {item}
                  </li>
                ))
            ...
            <ul className="pl-8 space-y-6 list-disc list-inside">
              ...
              ) : careerFiltered[0]?.career?.education_training?.length > 0 ? (
                careerFiltered[0]?.career?.education_training.map((item, index) => (
                  <li className="font-[500] list-outside text-[18px]" key={index}>
                    {item}
                  </li>
                ))
        ...
        <div>
          ...
          {loader ? (
            ...
            <p className="text-[#000000cc]">
              {careerFiltered[0]?.career?.career_growth_opportunities || "No Data Found "}
            </p>
          )}
        </div>
        <div>
